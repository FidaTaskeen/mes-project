    ...
    <Layout portalName="Supervisor Portal" theme="green" navGroups={navGroups}>
      ...
      <div className="bg-white rounded-xl shadow-sm border p-4 mb-4">
        ...
        <div className="flex gap-2">
          <button onClick={loadData} className="bg-green-700 text-white px-4 py-1.5 rounded-lg text-sm font-medium">
            Search
          </button>
            ...
            {loading ? (
              ...
              logs.map((log) => (
                <tr key={log._id} className="border-t">
                  <td className="px-4 py-3 font-medium text-green-700">{log.jobOrder?.jobOrderNo}</td>
