        ...
        <table className="w-full text-sm whitespace-nowrap">
          ...
          <tbody>
            {loading ? (
              ...
              jobOrders.map((jo) => {
                const fullyProcessed = jo.completedQuantity + jo.rejectQuantity >= jo.quantity;
                return (
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          disabled={jo.status === "Completed" || !fullyProcessed}
                          className={`w-7 h-7 rounded flex items-center justify-center ${
                          ...
                          title={
                            jo.status === "Completed"
                              ...
                              : fullyProcessed
                              ? "Mark Completed"
                              : `Cannot complete: ${jo.completedQuantity + jo.rejectQuantity}/${jo.quantity} processed`
                          }
                        >
